    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-[1120px] mx-auto px-6 pt-24 md:pt-28 pb-8">
          ...
          <p className="text-[15px] text-white/40 leading-[1.8] max-w-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="border border-[#171717] p-6">
              <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/15 mb-4">Our Story</div>
              <div className="space-y-4 text-[14px] text-white/45 leading-[1.8]">
            ...
            <div className="border border-[#171717] p-6">
              ...
              <p className="text-[14px] text-white/40 leading-[1.8] mb-5">Our vision has always extended beyond wins and losses. We prioritize giving athletes the opportunity to:</p>
            ...
            {/* Development First */}
            <div className="border border-[#171717] p-6">
              <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/15 mb-4">Development First</div>
              <p className="text-[14px] text-white/40 leading-[1.8] mb-5">As our program continues to grow, our priorities remain the same: player inclusion and player development above everything else. We believe every athlete deserves:</p>
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 mb-6">
                {["Opportunity", "Instruction", "Mentorship", "Resources", "Information", "Belief"].map((item, i) => (
                  <div key={i} className="border border-[#171717] py-2.5 text-center">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-white/50">{item}</span>
                  </div>
                ))}
              </div>
              <div className="space-y-4 text-[14px] text-white/45 leading-[1.8]">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Impact */}
            <div className="border border-[#171717] p-6">
              <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/15 mb-4">Impact</div>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-white/20">{s.label}</span>
            ...
            {/* Mission Statement */}
            <div className="border border-[#171717] bg-radial p-6">
              <div className="text-[13px] text-white/40 leading-[1.75] italic">
            ...
            <div className="border border-[#171717] p-6 text-center">
              ...
              <p className="text-[11px] text-white/25 mb-4">Ready to be part of something built for the players?</p>
