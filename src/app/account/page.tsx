...
const statusStyles: Record<string, string> = {
  ...
  draft: "bg-white/[0.04] text-white/80 border-white/10",
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-[13px] text-white/70 mt-1.5 capitalize">{role} account</p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <div className="flex items-center justify-between mb-4">
              <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/55">Your Team</div>
            ...
            {team ? (
              ...
              <p className="text-xs text-white/65">No team found.</p>
            )}
          </Card>

          <Card>
            <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/55 mb-4">Quick Links</div>
      ...
      {role === "admin" && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/55 mb-4">Administration</div>
            <div className="space-y-2">
      ...
      {role === "applicant" && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/55 mb-4">Coaches</div>
            <p className="text-xs text-white/70 mb-4">Register your town team to join the Apex Academy League.</p>
            <ActionLink href="/league/register" label="Register a Team" sub="Submit in under a minute" />
          </Card>
          <Card>
            <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/55 mb-4">Explore</div>
            <div className="space-y-2">
