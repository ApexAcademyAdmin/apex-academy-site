    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <p className="text-xs text-white/25">Entering the Apex ecosystem...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6 py-28 lg:py-16 bg-black lg:bg-[#0A0A0A]">
        <div className="w-full max-w-sm">
          ...
          <p className="text-xs text-white/25 mb-8">Access your Apex Academy account.</p>

          <div className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-[9px] font-bold uppercase tracking-[0.2em] text-white/20 mb-2">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/20">Password</label>
                <a href="#" className="text-[9px] font-bold uppercase tracking-wider text-white/15 no-underline hover:text-[#17FC13]/50 transition-colors">Forgot?</a>
              </div>
            ...
            {/* Google placeholder */}
            <button className="w-full py-3.5 border border-[#222] text-white/40 text-[11px] font-bold uppercase tracking-wider cursor-pointer bg-transparent hover:border-white/15 hover:text-white/60 transition-all flex items-center justify-center gap-2.5">
