    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6 py-28 lg:py-16 bg-black lg:bg-[#0A0A0A]">
        <div className="w-full max-w-sm">
          ...
          <p className="text-xs text-white/65 mb-8">Join the Apex Academy ecosystem.</p>

          <div className="space-y-4">
            {/* Email */}
            <div>
              <label className="block text-[9px] font-bold uppercase tracking-[0.2em] text-white/60 mb-2">Email <span className="text-[#17FC13]/30">*</span></label>
              <input
                type="email"
                value={email}
            ...
            {/* Password */}
            <div>
              <label className="block text-[9px] font-bold uppercase tracking-[0.2em] text-white/60 mb-2">Password <span className="text-[#17FC13]/30">*</span></label>
            ...
            {/* Confirm Password */}
            <div>
              <label className="block text-[9px] font-bold uppercase tracking-[0.2em] text-white/60 mb-2">Confirm Password <span className="text-[#17FC13]/30">*</span></label>
              <input
                type="password"
                value={confirm}
