...
export const ALL_TEAMS: Record<string, TeamData> = {
  "premier": {
    ...
    roster: [
      { number: "1", name: "Joel Rojas", pos: "—", year: "2026", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "2", name: "Donovan O'Brien", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "3", name: "Shawn Fusco", pos: "—", year: "2027", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "4", name: "Kayleb Seeley", pos: "—", year: "2027", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "5", name: "Hugh Speer", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "6", name: "Preston Ardolino", pos: "—", year: "2027", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "7", name: "Conor Brown", pos: "—", year: "2027", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "8", name: "Campbell Callahan", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "9", name: "Devin Milonopoulos", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "10", name: "Oliver Song", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "11", name: "Henry Kelsey", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "12", name: "Josh Silber", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
    ],
    coaches: [
  ...
  "prospects": {
    ...
    roster: [
      { number: "1", name: "Linus Henke", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "2", name: "Nick Young", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "3", name: "Luke Wood", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "4", name: "Bobby Wolfe", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "5", name: "Asa Brown", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "6", name: "Justin Beerbohm", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "7", name: "Colin Picardo", pos: "—", year: "2030", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "8", name: "Jack Alexandrov", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "9", name: "Noah Sterman", pos: "—", year: "2030", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "10", name: "Van Easter", pos: "—", year: "2028", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
      { number: "11", name: "Rafi Crane", pos: "—", year: "2029", bats: "—", throws: "—", ht: "—", wt: "—", hometown: "—" },
    ],
    coaches: [
      { name: "Gary Meskell", role: "Head Coach", bio: "" },
      { name: "Brandon McMahon", role: "Assistant Coach", bio: "" },
